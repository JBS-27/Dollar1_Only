...
/** Centroids for pins. Unused countries stay dark on the globe — they are simply absent. */
export const COUNTRIES: CountryMeta[] = [
  ...
  { code: "BS", name: "Bahamas", lat: 25.03, lng: -77.4 },
  ...
  { code: "KM", name: "Comoros", lat: -11.65, lng: 43.33 },
  ...
  { code: "GW", name: "Guinea-Bissau", lat: 11.8, lng: -15.18 },
  ...
  { code: "MW", name: "Malawi", lat: -13.25, lng: 34.3 },
  ...
  { code: "VC", name: "Saint Vincent", lat: 12.98, lng: -61.29 },
  ...
  { code: "SY", name: "Syria", lat: 34.8, lng: 38.0 },
  ...
  { code: "MO", name: "Macao", lat: 22.2, lng: 113.54 },
...
export const VALID_COUNTRY_CODES = new Set(COUNTRIES.map((country) => country.code));
